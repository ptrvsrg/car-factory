...
/**
 * The type {@code Worker} is class that implements {@link ru.nsu.ccfit.petrov.task4.threadpool.TaskThread TaskThread} for
 * {@link ru.nsu.ccfit.petrov.task4.threadpool.ThreadPool ThreadPool} and describes worker that has unique 128-bit ID.
 *
 * @author ptrvsrg
 */
public class Worker
